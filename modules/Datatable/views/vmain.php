			...
			<div class="liner">
				<div class="toc">
					...
					<div class="toc-group">
						...
						<ul class="toc">
							<li>
								<a href="<?php echo base_url('Datatable/remap/datatable_json'); ?>">Ajax data source (objects)</a>
							</li>
							<li>
								<a href="<?php echo base_url('Datatable/remap/datatable_json_database'); ?>">Ajax data source (objects) Database</a>
							</li>
							<li>
								<a href="<?php echo base_url('Datatable/remap/datatable_json_columndata'); ?>">Dynamic Column</a>
							</li>
							<li>
								<a href="<?php echo base_url('Datatable/remap/datatable_complete'); ?>">Datatable Complete</a>
							</li>
						</ul>
					</div>
				</div>
